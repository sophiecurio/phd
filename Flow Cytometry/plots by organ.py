...
#Genotype = ['WT 18-20', 'KO 18-20', 'WT endpoint', 'KO endpoint']
#
#'WT 18-20' = data[data.Who == 'SCC']
#'WT 18-20' = data[data.Genotype == 'APC/WT']
#
#'KO 18-20' = data[data.Who == 'SCC']
#'KO 18-20' = data[data.Genotype == 'APC/KO']
#
#'WT endpoint' = data[data.Who == 'CT']
#'WT endpoint' = data[data.Genotype == 'APC/WT']
#
#'KO endpoint' = data[data.Who == 'CT']
#'KO endpoint' = data[data.Genotype == 'APC/KO']



# Tcells = ['CD8+IL-17+', 'gdT+IL-17+', 'CD4+IL-17+']
#Tcells = ['CD4', 'CD8', 'gdT', 'CD3']
#Tcells = ['CD4/PD-1', 'CD8/PD-1', 'gdT/PD-1', 'NK/PD-1']
#Tcells = ['CD4/NKG2D', 'CD8/NKG2D', 'gdT/NKG2D', 'NK/NKG2D']
Tcells = ['CD11bhigh/M-MDSC/NKG2DL', 'CD11bhigh/PMN-MDSC/NKG2DL', 'CD11bhigh/Macrophages/NKG2DL']



i = 0
fig, axes_group = plt.subplots(1, 3, sharex=True, sharey=True, figsize=(7, 5))
for axes in axes_group.flatten():
        ...
        i = i+1   
        sns.despine()
#        fig.savefig(organ+'stim', dpi=400)
